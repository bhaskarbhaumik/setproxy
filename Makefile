...
pkgdatadir = $(datadir)/setproxy
pkgincludedir = $(includedir)/setproxy
pkglibdir = $(libdir)/setproxy
pkglibexecdir = $(libexecdir)/setproxy
...
am_setproxy_OBJECTS = setproxy-setproxy.$(OBJEXT)
setproxy_OBJECTS = $(am_setproxy_OBJECTS)
setproxy_LDADD = $(LDADD)
setproxy_LINK = $(CCLD) $(setproxy_CFLAGS) $(CFLAGS) $(AM_LDFLAGS) \
	$(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
am__depfiles_remade = ./$(DEPDIR)/setproxy-setproxy.Po
am__mv = mv -f
AM_V_lt = $(am__v_lt_$(V))
...
CTAGS = ctags
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"setproxy\" -DPACKAGE_TARNAME=\"setproxy\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"setproxy\ 0.1.0\" -DPACKAGE_BUGREPORT=\"your-email@example.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"setproxy\" -DVERSION=\"0.1.0\" -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DHAVE_ARPA_INET_H=1 -DHAVE_NETDB_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_SYS_SOCKET_H=1 -DHAVE_UNISTD_H=1 -DHAVE_SOCKET=1
DEPDIR = .deps
ECHO_C = \c
ECHO_N = 
ECHO_T = 
...
PACKAGE_NAME = setproxy
PACKAGE_STRING = setproxy 0.1.0
PACKAGE_TARNAME = setproxy
PACKAGE_URL = 
...
setproxy$(EXEEXT): $(setproxy_OBJECTS) $(setproxy_DEPENDENCIES) $(EXTRA_setproxy_DEPENDENCIES) 
	@rm -f setproxy$(EXEEXT)
	$(AM_V_CCLD)$(setproxy_LINK) $(setproxy_OBJECTS) $(setproxy_LDADD) $(LIBS)
...
include ./$(DEPDIR)/setproxy-setproxy.Po # am--include-marker
...
setproxy-setproxy.o: setproxy.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(setproxy_CFLAGS) $(CFLAGS) -MT setproxy-setproxy.o -MD -MP -MF $(DEPDIR)/setproxy-setproxy.Tpo -c -o setproxy-setproxy.o `test -f 'setproxy.c' || echo '$(srcdir)/'`setproxy.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/setproxy-setproxy.Tpo $(DEPDIR)/setproxy-setproxy.Po
#	$(AM_V_CC)source='setproxy.c' object='setproxy-setproxy.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(setproxy_CFLAGS) $(CFLAGS) -c -o setproxy-setproxy.o `test -f 'setproxy.c' || echo '$(srcdir)/'`setproxy.c

setproxy-setproxy.obj: setproxy.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(setproxy_CFLAGS) $(CFLAGS) -MT setproxy-setproxy.obj -MD -MP -MF $(DEPDIR)/setproxy-setproxy.Tpo -c -o setproxy-setproxy.obj `if test -f 'setproxy.c'; then $(CYGPATH_W) 'setproxy.c'; else $(CYGPATH_W) '$(srcdir)/setproxy.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/setproxy-setproxy.Tpo $(DEPDIR)/setproxy-setproxy.Po
#	$(AM_V_CC)source='setproxy.c' object='setproxy-setproxy.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(setproxy_CFLAGS) $(CFLAGS) -c -o setproxy-setproxy.obj `if test -f 'setproxy.c'; then $(CYGPATH_W) 'setproxy.c'; else $(CYGPATH_W) '$(srcdir)/setproxy.c'; fi`
